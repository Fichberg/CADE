...
esperado que busquemos métodos e técnicas para medir quão corretas estas anotações geradas estão. Além disso, estas técnicas também servem para que possamos ter
valores de orientação para refinarmos as respostas obtidas, de tal modo que podemos melhorar os valores das taxas de precisão e cobertura e da Medida-F. Esta seção, portanto,
...
\subsection{Precisão, Cobertura e Medida-F}
