...
Mas de quão extenso estamos falando, afinal? Um exemplo de córpus extenso é o Brown University Standard Corpus of Present-Day American English [8]\footnote[1]{
...
\begin{quote}
  ...
  Por meio da \fbox{presente operação}$_{\text{Operação}}$, a \fbox{HNA}$_{\text{Organização}}$ visa obter benefícios econômicos decorrentes dos novos investimentos para
